...
<form id="form" name="form" method="post" action= "in1.php" > 
       ...
       <table width="95%" border="0" cellpadding="2" cellspacing="2" class="text_black">
		...
		for($i=$num;$i>=1;$i--) $row = mysql_fetch_array($result6, MYSQL_ASSOC) ?>
		 	...
		 	<option value= <?php echo $row['sub_id'];?>><?php echo $row['sub_id'];?></option>
...
<th><?php echo $row['sub_id']; ?>
</th>
<th><?php echo $row['sub_name']; ?>
</th>
<th><?php echo $row['internal_I']; ?>
</th>
<th><?php echo $row['internal_II']; ?>
</th>
<th><?php echo $row['semester']; ?>
</th>
    ...
    <tr>  <td><input name="id" type="text" class="menu" id="name" maxlength="255" /></td>
                              ...
                              <td><input name="sub_id" type="text" class="menu" id="name" maxlength="255" /></td>

                           
                              <td><input name="sub_name" type="text" class="menu" id="name" maxlength="255" /></td>

                            
                              <td><input name="internal_I" type="text" class="menu" id="name" maxlength="255" /></td>

                          

                              <td><input name="internal_II" type="text" class="menu" id="name" maxlength="255" /></td>

                            <td><input name="semester" type="text" class="menu" id="name" maxlength="255" /></td>
        ...
        <br />
                            <p>
                              ...
                              <label>
                            <a href="update.php"><input type="button" name="id" value="FINISH"></a>
                              </label><br>
